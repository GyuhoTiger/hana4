...
// Fibonacci numbers Ex1) (using loop)
...
console.log("< loopFibonacci >");
console.log(loopFibonacci(5));
console.log("----------------------------");

// Fibonacci numbers Ex2) (using recursive)
...
// Fibonacci numbers Ex3) (using memoized)

const memFib = memoizedFibonacci(recursiveFibonacci);
